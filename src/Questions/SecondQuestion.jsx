...
export default function SecondQuestion(props) {
  ...
  return (
    <div>
      ...
      <div>
      <button className='btn5' onClick={props.wrong}>Nile</button>
        <button className='btn5' onClick={changeSecondQuestion}>Amazon</button>
        <button className='btn5' onClick={props.wrong}>Yangtze</button>
        <button className='btn5'onClick={props.wrong}>Mississippi</button>
      </div>
    </div>
  )
}
